...
import com.example.android.pets.data.PetsSQLiteHelper;

import static com.example.android.pets.data.PetsSQLiteHelper.LOG_TAG;
...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
     ...
     * the view, and change the mPetHasChanged boolean to true.
     */
    ...
    private void savePet() {
        ...
        if (mCurrentPetUri == null) {
            ...
            //Show the toast message whether or not the insertion was successful
            if (uri != null)
                Toast.makeText(this, getString(R.string.pet_saved), Toast.LENGTH_SHORT).show();
            else
                Toast.makeText(this, getString(R.string.pet_saving_error), Toast.LENGTH_SHORT).show();

        } else {
            //Otherwise this is an EXISTING pet, so update the pet with content URI: mCurrentPetUri
            //and pass in the new ContentValues. Pass in null for the selection and selection args
            //because mCurrentPetUri will already identify the correct row int the database that
            //we want to modify.
            int rowsAffected = getContentResolver().update(mCurrentPetUri, values, null, null);

            //Show a toast messsage depending on whether or not the update was successful.
            if (rowsAffected == 0)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_save:
                // Save/Update a single pet record
                savePet();
            ...
            case android.R.id.home:
                //If the hasn't changed, continue with navigating up to parent activity
    ...
    private void showUnsavedChangesDialog(DialogInterface.OnClickListener discardButtonClickListener) {
        ...
        builder.setNegativeButton(R.string.keep_editing, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                //so dismiss the dialog and keep editing pet
